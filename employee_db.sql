...
VALUES 
(101, 'Rahul Sharma', 'Data Analytics', 60000.00),
(102, 'Priya Singh', 'HR', 45000.00),
(103, 'Amit Verma', 'Finance', 55000.00);
...
SELECT * FROM Employee WHERE department = 'Data Analytics';

UPDATE Employee SET salary = 65000 WHERE id = 101;
